...
//  Define os pinos para o teclado. 
  ...
  #define CONFIG_LINHAS()     P6DIR &= ~0x0f
  #define CONFIG_LINHA_1      P6DIR_bit.P0
  #define CONFIG_LINHA_2      P6DIR_bit.P1
  #define CONFIG_LINHA_3      P6DIR_bit.P2
  #define CONFIG_LINHA_4      P6DIR_bit.P3
   
  #define LINHA_1     P6OUT_bit.P0
  #define LINHA_2     P6OUT_bit.P1
  #define LINHA_3     P6OUT_bit.P2
  #define LINHA_4     P6OUT_bit.P3
